        ...
        do {
            ...
            switch (op) {
                ...
                case 4:
                    ...
                    System.out.println("OLD.Presidente del equipo "+Equipo[n].getNombreequipo()+" : ");
                    System.out.println("Entrenador: "+Equipo[n].getNombreentrenador());
                    ES.continuar();
                    continue;
                case 5:
                    int j= ES.leeN("Introduce el Nº de OLD.Jugador que quieres traspasar: ");

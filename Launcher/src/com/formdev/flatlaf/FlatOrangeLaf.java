 ...
 * @author Karl Tauber
 */
public class FlatOrangeLaf
	extends FlatLaf
{
	public static final String NAME = "FlatLaf Orange";
	...
	public static boolean setup() {
		return setup( new FlatOrangeLaf() );
	}
	...
	public static void installLafInfo() {
		installLafInfo( NAME, FlatOrangeLaf.class );
	}
	...
	public String getDescription() {
		return "FlatLaf Orange Look and Feel by Ren0X";
	}

...
public class ES {
    ...
    public static void debug(int x) {
        System.out.println(ANSI_YELLOW+"Debug N�: "+ANSI_RED+x+ANSI_RESET);
    }
    ...
    public static int leeN(String mensaje,int minimo) {
        ...
        do {
            entero = leeN(mensaje);
            if (entero < minimo) {
                System.err.println(" EL M�NIMO VALOR PERMITIDO ES: " + minimo);
            }
        } while (entero < minimo);
        return entero;
    }
    public static int leeN(String mensaje,int minimo, int maximo) {
        ...
        do {
            ...
            if (entero < minimo) {
                ...
                System.err.println(" EL M�XIMO VALOR PERMITIDO ES: " + maximo);
            }
